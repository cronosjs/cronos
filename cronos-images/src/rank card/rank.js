...
module.exports = class rank {
  constructor() {
    this.backgroundImage = `${__dirname}/../../assets/img/gradient.png`;
    ...
    this.colorLevelBox = "#A85EFF";
    this.colorReputationBox = "#A85EFF";
  ...
  async toAttachment() {
    ...
    // Title
      ...
      ctx.font = applyText(canvas, this.title, 35, 690, "Bold");
      ctx.fillText(this.title, 50 + 240 + 45 + 5, 80 + 45 + 15);
